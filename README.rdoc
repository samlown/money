...
an example of how it works:
  ...
  Money.add_rate("CAD", 1.24515)
  Money.add_rate("USD", 0.803115)
...
or
  ...
  Money.us_dollar(100).to_cad              # => Money.new(123, "CAD")
  Money.ca_dollar(123).to_usd              # => Money.new(100, "USD")
...
Fetch the exchange rates published by the European Bank
  ...
  Money.default_bank.auto_fetch 3600      # Fetch the rates every 10 minutes
